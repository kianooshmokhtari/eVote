...
public class EditVoterEmailCtrl{
	...
	public EditVoterEmailCtrl (ObjectLayer objectLayer) {
		this.objectLayer = objectLayer;
	}
	
	public void edit(String userName, String newEmail) throws EVException{
		...
		if(!voters.isEmpty()){
			...
			voter = voters.get(0);
			voter.setEmailAddress(newEmail);
