...
public class EditVoterFirstNameCtrl{
	...
	public EditVoterFirstNameCtrl (ObjectLayer objectLayer) {
		this.objectLayer = objectLayer;
	}
	
	public void edit(String userName, String newFirstName) throws EVException{
		...
		if(!voters.isEmpty()){
			...
			voter = voters.get(0);
			voter.setFirstName(newFirstName);
