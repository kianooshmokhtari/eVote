...
public class EditVoterPasswordCtrl{
	...
	public EditVoterPasswordCtrl (ObjectLayer objectLayer) {
		this.objectLayer = objectLayer;
	}
	
	public void edit(String userName, String newPass) throws EVException{
