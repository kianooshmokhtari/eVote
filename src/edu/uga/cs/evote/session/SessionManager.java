...
public class SessionManager {
	...
	public static Session createSession() throws EVException {
	...
	public static String storeSession(Session session) throws EVException {
	 ...
	 * @throws GVException
	 */
	public static void logout(Session s) throws EVException {
	 ...
	 * @throws GVException
	 */
	public static void logout(String ssid) throws EVException {
	 ...
	 * @throws GVException
	 */
	protected static void removeSession(Session s) throws EVException {
		try {
	 ...
	 * @throws EVException
	 */
	public static String secureHash(String input) throws EVException {
		...
		try {
			...
			throw new EVException("SessionManager.secureHash: Invalid Encryption Algorithm");
		}
