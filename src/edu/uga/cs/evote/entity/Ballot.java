...
public interface Ballot extends Persistable
{
    ...
    /** Return a boolean value indicating if the voting results on this Ballot have been approved.
     * @return a boolean value indicating if the voting results on this Ballot have been approved
     */
    public boolean getApproved();

    /** Set the new boolean value indicating if the voting results on this Ballot have been approved.
     * @param approved a boolean value indicating if the voting results on this Ballot have been approved
     */
