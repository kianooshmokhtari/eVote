...
public interface ObjectLayer
{
     ...
     * @param ballot the ballot on which this issue is included
     * @return a new Issue object instance with the given attribute value
     * @throws EVException in case question is null or if the ballot is not persistent
     */
     ...
     * @param ballot the ballot on which this election is included
