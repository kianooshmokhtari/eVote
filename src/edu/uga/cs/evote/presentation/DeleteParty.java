...
public class DeleteParty extends HttpServlet{
	...
	static String resultTemplateName = "PartyDeleted.ftl";
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			throw new ServletException("DeleteParty.doPost: Can't load template in: " + templateDir + ": " + e.toString());
		}
        ...
        //
        name = req.getParameter( "deletePartyName" );
        ...
        try {
            id = logicLayer.deleteParty(name);
        } 
        catch ( Exception e ) {
