...
public class DeleteIssue extends HttpServlet{
	...
	static String resultTemplateName = "IssueDeleted.ftl";
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			throw new ServletException("DeleteIssue.doPost: Can't load template in: " + templateDir + ": " + e.toString());
		}
        ...
        //
        ID = req.getParameter( "deleteIssueID" );
        
        if( ID == null ){
        	EvoteError.error(cfg, toClient, "Issue ID not specified");
        }
        
        try {
            id = logicLayer.deleteIssue(ID);
        } 
        catch ( Exception e ) {
