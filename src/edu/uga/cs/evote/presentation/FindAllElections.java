...
public class FindAllElections extends HttpServlet{
	
	private static final long serialVersionUID = 1L;
	static String templateDir = "WEB-INF/templates";
	static String resultTemplateName = "AllElections.ftl";
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
     ...
     // Load templates from the WEB-INF/templates directory of the Web app.
     		try {
     			...
     			throw new ServletException("FindAllElections.doGet: Can't load template in: " + templateDir + ": " + e.toString());
     		}
     ...
     // Prepare the HTTP response:
        ...
        try{
        	elections = logicLayer.findAllElections();
        }
        catch (EVException e){
