...
public class DeleteDistrict extends HttpServlet{
	...
	static String resultTemplateName = "DistrictDeleted.ftl";
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			throw new ServletException("DeleteDistrict.doPost: Can't load template in: " + templateDir + ": " + e.toString());
		}
        ...
        //
        name = req.getParameter( "deleteDistrictName" );
        
        if( name == null ){
        	EvoteError.error(cfg, toClient, "District name not specified");
        }
        
        try {
            district_id = logicLayer.deleteDistrict(name);
        } 
        catch ( Exception e ) {
