...
public class DeleteElection extends HttpServlet{
	...
	static String resultTemplateName = "ElectionDeleted.ftl";
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			throw new ServletException("DeleteElection.doGet: Can't load template in: " + templateDir + ": " + e.toString());
		}
        ...
        //
        id = req.getParameter( "deleteElectionID" );
        
        if( id == null ){
        	EvoteError.error(cfg, toClient, "Election id not specified");
        }
        
        try {
            election_id = logicLayer.deleteElection(id);
        } 
        catch ( Exception e ) {
        ...
        //
        root.put( "election_id", new Long( election_id ) );
