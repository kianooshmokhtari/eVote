...
public class EditElectoralDistrict extends HttpServlet{
		...
		static String resultTemplateName = "DistrictCreated.ftl";
		...
		public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	        ...
	        //
	        oldName = req.getParameter( "existingDistrict" );
	        newName = req.getParameter( "newDistrict" );

	        if( oldName == null ) {
	            EvoteError.error( cfg, toClient, "Original name not specified" );
	            return;
	        }
	        
	        if( newName == null ) {
	            EvoteError.error( cfg, toClient, "New name not specified" );
	            return;
	        }

	        try {
	            district_id = logicLayer.editElectoralDistrict(oldName, newName);
	        } 
	        catch ( Exception e ) {
	        ...
	        //
	        root.put( "district_name", newName );
	        root.put( "district_id", new Long( district_id ) );
