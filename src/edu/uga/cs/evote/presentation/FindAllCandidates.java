...
public class FindAllCandidates extends HttpServlet{

	private static final long serialVersionUID = 1L;
	static String templateDir = "WEB-INF/templates";
	static String resultTemplateName = "AllCandidates.ftl";
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
     ...
     // Load templates from the WEB-INF/templates directory of the Web app.
     		try {
     			...
     			throw new ServletException("FindAllCandidates.doGet: Can't load template in: " + templateDir + ": " + e.toString());
     		}
     ...
     // Prepare the HTTP response:
        ...
        try{
        	candidates = logicLayer.findAllCandidates();
        }
        catch (EVException e){
