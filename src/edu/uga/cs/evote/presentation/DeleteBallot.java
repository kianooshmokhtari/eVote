...
public class DeleteBallot extends HttpServlet{
	
	private static final long serialVersionUID = 1L;
	static String templateDir = "WEB-INF/templates";
	static String resultTemplateName = "BallotDeleted.ftl";
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			throw new ServletException("DeleteBallot.doPost: Can't load template in: " + templateDir + ": " + e.toString());
		}
        ...
        //
        ballotId = req.getParameter( "deleteBallot" );
        
        if( ballotId == null ){
        	EvoteError.error(cfg, toClient, "Ballot id not specified");
        }
        
        try {
            id = logicLayer.deleteBallot(ballotId);
        } 
        catch ( Exception e ) {
